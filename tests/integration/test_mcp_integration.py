...
def mcp_call_tool(tool_name: str, arguments: dict[str, Any], timeout: float | None = None) -> Any:
...
def prepare_and_load_model_mcp(model_id: str) -> None:
    ...
    """
    result = mcp_call_tool("load_model", {"model": model_id}, timeout=MODEL_LOAD_TIMEOUT)
