...
import mlx.nn as nn
from mlx_lm.models.deepseek_v3 import DeepseekV3DecoderLayer, ModelArgs

from .base import BaseRingModel


class DeepseekV3RingModel(BaseRingModel):
    ...
    def __init__(
        ...
        for i, layer in enumerate(sorted(assigned_layers or [])):
            self.layers.append(DeepseekV3DecoderLayer(config, layer))
